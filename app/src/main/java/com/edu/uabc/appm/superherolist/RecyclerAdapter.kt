...
class RecyclerAdapter : RecyclerView.Adapter<RecyclerAdapter.ViewHolder>() {
    var superheros: MutableList<MainActivity.Superhero> = ArrayList()
    lateinit var context:Context
    fun RecyclerAdapter(superheros : MutableList<MainActivity.Superhero>, context: Context){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return ViewHolder(layoutInflater.inflate(R.layout.item_superhero_list,
            parent, false))
    }
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(superhero: MainActivity.Superhero, context: Context){
